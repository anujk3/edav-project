(function() {
    ...
    d3.queue()
        .defer(d3.csv, "vis2.csv", function(d) {
    ...
    function ready(error, datapoints) {
        ...
        svg.selectAll(".workout-circle")
            ...
            .attr("r", function(d){
                return 5;//totalMinsScale(d.totalMins);
            })
            .attr("cx", function(d) {
        ...
        d3.select("#btn_cycling").on('click', function (d) {
            cur_selection = "cycling";
            redrawCircles(minDate, maxDate);
        });
